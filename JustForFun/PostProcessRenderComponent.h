...
namespace JFF
{
	...
	public:
		...
		*/
		virtual void sendPostProcessingTextures(const std::weak_ptr<Framebuffer>& ppFBO) override;
		...
		virtual void executeCustomRenderPass(const std::weak_ptr<Framebuffer>& ppFBO);
