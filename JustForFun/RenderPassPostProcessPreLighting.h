...
namespace JFF
{
	...
	class RenderPassPostProcessPreLighting : public RenderPass
	{
	public:
		// Ctor & Dtor
		explicit RenderPassPostProcessPreLighting(Engine* const engine);
		virtual ~RenderPassPostProcessPreLighting();

		// Copy ctor and copy assignment
		RenderPassPostProcessPreLighting(const RenderPassPostProcessPreLighting& other) = delete;
		RenderPassPostProcessPreLighting& operator=(const RenderPassPostProcessPreLighting& other) = delete;

		// Move ctor and assignment
		RenderPassPostProcessPreLighting(RenderPassPostProcessPreLighting&& other) = delete;
		RenderPassPostProcessPreLighting operator=(RenderPassPostProcessPreLighting&& other) = delete;
