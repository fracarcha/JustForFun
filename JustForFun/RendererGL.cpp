...
JFF::RendererGL::RendererGL() : 
	engine(nullptr),
	renderPathHint(RenderPath::FORWARD),
	...
	maxPointLightsForwardShading(4),
	maxDirectionalLightsForwardShading(4),
	maxSpotLightsForwardShading(4),
...
void JFF::RendererGL::postLoad(Engine* engine)
{
	...
	// Select render path
	activeRenderPath = renderPathHint;
...
void JFF::RendererGL::addRenderable(RenderComponent* const renderable)
{
	...
	// Add a copy of post process renderables to render-to-screen renderables
...
void JFF::RendererGL::removeRenderable(RenderComponent* const renderable)
{
	...
	// Remove the copy of post process renderables to render-to-screen renderables
	if (materialDomain == Material::MaterialDomain::POST_PROCESS)
...
void JFF::RendererGL::setRenderPath(RenderPath path)
{
	renderPathHint = path;
}
