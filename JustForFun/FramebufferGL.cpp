...
JFF::FramebufferGL::FramebufferGL(PrefabFramebuffer fboType, unsigned int width, unsigned int height, unsigned int samplesPerPixel) :
	isDestroyed(false),
	...
	clearMask(0u)
{
	JFF_LOG_INFO("Ctor FramebufferGL")

	extractParamsData(fboType, width, height, samplesPerPixel);
	create();
}

JFF::FramebufferGL::FramebufferGL(const Params& params) :
	isDestroyed(false),
...
JFF::FramebufferGL::~FramebufferGL()
{
	JFF_LOG_INFO("Dtor FramebufferGL")
...
void JFF::FramebufferGL::enable(bool clearBuffers)
{
...
void JFF::FramebufferGL::disable()
{
...
void JFF::FramebufferGL::useTexture(AttachmentPoint attachmentPoint, int textureUnit)
{
	try
	{
...
void JFF::FramebufferGL::setSize(unsigned int width, unsigned int height)
{
	for (auto& pair : mainFBO.fboAttachments)
	{
...
void JFF::FramebufferGL::getSize(AttachmentPoint attachmentPoint, unsigned int& width, unsigned int& height)
{
	try
	{
...
void JFF::FramebufferGL::copyBuffer(
	AttachmentPoint dstAttachmentPoint, 
	AttachmentPoint srcAttachmentPoint,
	std::weak_ptr<Framebuffer> src)
{
	std::shared_ptr<FramebufferGL> srcGL = std::dynamic_pointer_cast<FramebufferGL>(src.lock());
	if (srcGL)
	{
...
void JFF::FramebufferGL::destroy()
{
	isDestroyed = true;
...
inline void JFF::FramebufferGL::extractParamsData(PrefabFramebuffer fboType, unsigned int width, unsigned int height, unsigned int samplesPerPixel)
{
	switch (fboType)
	{
...
inline void JFF::FramebufferGL::extractParamsData(const Params& params)
{
...
inline void JFF::FramebufferGL::create()
{
	/*
...
inline void JFF::FramebufferGL::createMainBuffer(AttachmentPoint attachmentPoint, AttachmentDataInternal& attachmentData)
{
...
inline void JFF::FramebufferGL::createMainFrameBuffer()
{
...
inline void JFF::FramebufferGL::createAuxBuffer(AttachmentPoint attachmentPoint, AttachmentDataInternal& attachmentData)
{
	if (attachmentData.renderBuffer)
	{
...
inline void JFF::FramebufferGL::createAuxFrameBuffer()
{
	// Create the framebuffer
...
inline void JFF::FramebufferGL::createRenderbufferMultisample(AttachmentPoint attachmentPoint, AttachmentDataInternal& attachmentData)
{
...
inline void JFF::FramebufferGL::createRenderBuffer(AttachmentPoint attachmentPoint, AttachmentDataInternal& attachmentData)
{
	glGenRenderbuffers(1, &attachmentData.buffer);
	glBindRenderbuffer(GL_RENDERBUFFER, attachmentData.buffer);
...
inline void JFF::FramebufferGL::createTexture2DMultisample(AttachmentPoint attachmentPoint, AttachmentDataInternal& attachmentData)
{
...
inline void JFF::FramebufferGL::createTexture2D(AttachmentPoint attachmentPoint, AttachmentDataInternal& attachmentData)
{
	glGenTextures(1, &attachmentData.buffer);
...
inline void JFF::FramebufferGL::createCubemap(AttachmentPoint attachmentPoint, AttachmentDataInternal& attachmentData)
{
...
inline GLenum JFF::FramebufferGL::attachmentPointToGL(AttachmentPoint attachmentPoint) const
{
...
inline GLenum JFF::FramebufferGL::texTypeToGL(TextureType texType) const
{
	switch (texType)
	{
...
inline GLint JFF::FramebufferGL::wrapModeToGL(Wrap wrapMode) const
{
	switch (wrapMode)
	{
...
inline GLint JFF::FramebufferGL::magFilterModeToGL(MagnificationFilter filter) const
{
	switch (filter)
	{
...
inline GLint JFF::FramebufferGL::minFilterModeToGL(MinificationFilter filter) const
{
	switch (filter)
	{
...
inline GLint JFF::FramebufferGL::texFormatToGL(AttachmentPoint attachmentPoint, unsigned int numColorChannels, bool HDR) const
{
	switch (attachmentPoint)
	{
	case JFF::Framebuffer::AttachmentPoint::DEPTH:
...
inline GLenum JFF::FramebufferGL::imgFormatToGL(AttachmentPoint attachmentPoint, unsigned int numColorChannels) const
{
	switch (attachmentPoint)
	{
	case JFF::Framebuffer::AttachmentPoint::DEPTH:
...
inline GLenum JFF::FramebufferGL::imgTypeToGL(AttachmentPoint attachmentPoint) const
{
	switch (attachmentPoint)
	{
	case JFF::Framebuffer::AttachmentPoint::DEPTH:
...
inline void JFF::FramebufferGL::configureReadAndWriteColorBuffers()
{
...
inline void JFF::FramebufferGL::checkFramebufferStatus() const
{
