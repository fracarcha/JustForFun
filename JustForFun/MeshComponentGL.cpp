...
#include "Log.h" // TODO: May need to put this include before MeshComponent to avoid Windows.h complaints

#include "GameObject.h"
#include <algorithm>

JFF::MeshComponentGL::MeshComponentGL(
	GameObject* const gameObject,
	const char* name, 
	bool initiallyEnabled, 
	const std::shared_ptr<Mesh>& mesh) :
	MeshComponent(gameObject, name, initiallyEnabled),
	mesh(mesh),
	vao(0u),
	drawData()
{
	JFF_LOG_INFO("Ctor MeshComponentGL")
}
...
JFF::MeshComponentGL::MeshComponentGL(
	...
	const char* name,
	bool initiallyEnabled, 
	const BasicMesh& predefinedShape) :
	MeshComponent(gameObject, name, initiallyEnabled),
	vao(0u),
	drawData()
{
	...
	switch (predefinedShape)
	{
		...
		case BasicMesh::SPHERE:
			mesh = std::make_shared<MeshSphere>(gameObject->engine);
			break;
...
JFF::MeshComponentGL::~MeshComponentGL()
{
	JFF_LOG_INFO("Dtor MeshComponentGL")
}

void JFF::MeshComponentGL::onStart()
{
...
void JFF::MeshComponentGL::onDestroy() noexcept
{
	glDeleteVertexArrays(1, &vao);
}

void JFF::MeshComponentGL::draw()
{
...
inline GLuint JFF::MeshComponentGL::genVBO()
{
...
inline GLuint JFF::MeshComponentGL::genEBO()
{
...
inline void JFF::MeshComponentGL::setVertexPointers()
{
...
inline void JFF::MeshComponentGL::configureDrawData()
{
...
inline GLenum JFF::MeshComponentGL::translatePrimitiveMethodToOpenGL(const Mesh::PrimitiveAssemblyMethod& assemblyMethod) const
{
