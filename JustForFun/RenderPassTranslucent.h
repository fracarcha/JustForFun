...
namespace JFF
{
	...
	// Similar to RenderPassSurfaceGL, but this class can draw objects with transparency
	class RenderPassTranslucent : public RenderPass
	{
	public:
		// Ctor & Dtor
		explicit RenderPassTranslucent(Engine* const engine);
		virtual ~RenderPassTranslucent();

		// Copy ctor and copy assignment
		RenderPassTranslucent(const RenderPassTranslucent& other) = delete;
		RenderPassTranslucent& operator=(const RenderPassTranslucent& other) = delete;

		// Move ctor and assignment
		RenderPassTranslucent(RenderPassTranslucent&& other) = delete;
		RenderPassTranslucent operator=(RenderPassTranslucent&& other) = delete;
	...
	protected:
		inline void renderPass(bool cullFrontFaces);
