	...
	name(name)
{
	...
	rootNodeObj->addComponent<MeshComponent>("Root render-to_screen plane mesh", true, MeshComponent::BasicMesh::PLANE);
	...
	rootNodeObj->addComponent<PostProcessRenderComponent>("Post process render component", true, "PostProcess.mat.ini");
