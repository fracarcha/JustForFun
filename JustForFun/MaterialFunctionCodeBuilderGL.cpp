...
{
	isPBR =
		params.lineBaseColor.tellp() != 0 ||
		params.lineNormalCamera.tellp() != 0 ||
		params.lineEmissionColor.tellp() != 0 ||
		params.lineMetalness.tellp() != 0 ||
		params.lineDiffuseRoughness.tellp() != 0 ||
		params.lineAmbientOcclusion.tellp() != 0 ||

		params.lineSheen.tellp() != 0 ||
		params.lineClearCoat.tellp() != 0 ||
		params.lineTransmission.tellp() != 0;
	...
	if (isPBR)
	{
		std::string lineBaseColor			= params.lineBaseColor.tellp() != 0			? params.lineBaseColor.str() : "vec4(0)";
		std::string lineNormalCamera		= params.lineNormalCamera.tellp() != 0		? params.lineNormalCamera.str() : "vec4(0)";
		std::string lineEmissionColor		= params.lineEmissionColor.tellp() != 0		? params.lineEmissionColor.str() : "vec4(0)";
		...
		std::string lineAmbientOcclusion	= params.lineAmbientOcclusion.tellp() != 0	? params.lineAmbientOcclusion.str() : "vec4(0)";
