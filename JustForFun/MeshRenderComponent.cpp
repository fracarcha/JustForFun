...
void JFF::MeshRenderComponent::sendEnvironmentMap(const std::shared_ptr<Cubemap>& envMap)
{
...
void JFF::MeshRenderComponent::sendPostProcessingTextures(const std::weak_ptr<Framebuffer>& ppFBO)
{
